...
@Component({
  selector: 'app-calculatecgpa',
  templateUrl: './calculatecgpa.component.html',
  styleUrls: ['./calculatecgpa.component.css']
})
export class CalculatecgpaComponent implements OnInit {
  ...
  constructor(private authapi: AuthapiService, private activatedRoute: ActivatedRoute, private route: Router, private formBuilder: FormBuilder) {}
